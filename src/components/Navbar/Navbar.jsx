...
export default function Navbar() {
  ...
  const commonLinks = [
      { href: '/', title: 'Home' },
      user ? { href: '#', title: 'Logout', onClick: handleLogout } : { href: '/auth', title: 'Login/Signup' },
  ];
  ...
  return (
    <nav className="bg-gray-800 p-4 relative">
        <div className="container mx-auto flex items-center justify-between ">
            <a href="/" className="text-xl font-bold text-white">LunchBreak</a>
            <button 
            ...
            <div className={`absolute md:relative top-full right-0 md:flex flex-col md:flex-row w-full md:w-auto bg-gray-800 md:bg-transparent ${isMenuOpen ? 'flex' : 'hidden'}`}>
